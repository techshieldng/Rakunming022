...
//     return ordersRef.doc(orderId).collection("messages").orderBy("createdAt", descending: true);
//   }
//
...
//   }
//
//   Future<DocumentReference> addOrder(ChatMessageModel data, String? orderId) async {
//     var doc = await ordersRef.doc(orderId).collection("messages").add(data.toJson());
//     doc.update({'id': doc.id});
//     return doc;
//   }
//
//   Future<void> addMessageToDb(DocumentReference senderDoc, ChatMessageModel data, UserData sender, UserData? user,
//       {File? image}) async {
//     String imageUrl = '';
//
//     if (image != null) {
